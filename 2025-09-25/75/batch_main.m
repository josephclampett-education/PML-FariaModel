...
% BATCH
BATCH_damping_scale = [3 4 5 6 7 8];
BATCH_R = CONST_RLIST;
...
VAR_effective_corral_radius_scale = 0.98;
% VAR_damping_scale = 6;
...
count0 = length(BATCH_damping_scale);
...
parfor i = 1:threadCount
    ...
    effective_corral_radius_scale = VAR_effective_corral_radius_scale;
    switch p.damping_type
        case 'scaled'
            p.effective_corral_radius = radius * effective_corral_radius_scale;
            p.damping_scale = BATCH_damping_scale(idx0);
    end
